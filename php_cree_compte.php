...
<body class="bg-body overflow-x-hidden mb-5">
    <nav class="container-fluid p-3 w-100 text-white">
        <section class="row">
            <div class="col">
                <a href="index.html"><img class="w-100" src="img/SVG/logo.svg"
                        alt="logo Aéro club de Frotey-les-Lure"></a>
            </div>
            <div class="col text-center mt-2">
                <a class="lien_nav text-decoration-none text-white" href="#bapteme">BAPTÈME DE L'AIR</a>
            </div>
            <div class="col text-center mt-2">
                <a class="lien_nav text-decoration-none text-white" href="">FORMATIONS</a>
            </div>
            <div class="col text-center mt-2">
                <a class="lien_nav text-decoration-none text-white" href="">FORFAITS</a>
            </div>
            <div class="col text-center mt-2">
                <a class="lien_nav text-decoration-none text-white" href="">À PROPOS</a>
            </div>
            <div class="col text-center mt-2">
                <a class="lien_nav text-decoration-none text-white" href="">ÉVÉNEMENTS</a>
            </div>
            <div class="col text-center mt-2">
                <a class="lien_nav text-decoration-none text-white" href="">GALERIE</a>
            </div>
            <div class="col text-center mt-2">
                <a class="lien_nav text-decoration-none text-white" href="">CONTACT</a>
            </div>
    ...
    <form action="_set_up_compt.php" method="post" class="mx-auto text-blue">
        ...
        <div class="mt-5 background rounded-4 pt-3 pb-3" id="card1">
            <section class="w-75 mx-auto d-flex flex-column">
                ...
                <input placeholder="ex : Glenn" type="text" name="prenom" required id='prenom'
                    onkeyup="verification_prenom()" class="rounded-3 input-custom p-1">

                <label for="Nom" class="mt-3 fs-5">Nom</label>
                <input placeholder="ex : Guillard" type="text" name="nom" required id="nom" onkeyup="verification_nom()"
                    class="rounded-3 input-custom p-1">
        ...
        <div class="mt-5 background rounded-4 pt-3 pb-3" id="card2">
            <section class="w-75 mx-auto d-flex flex-column">
                ...
                <input placeholder="ex : 13 place de la mairie" class="rounded-3 input-custom p-1" type="text"
                    name="physique_addresse" require id="physique_addresse" onkeyup="verif_physique()">

                <label for="code_addresse" class="mt-3 fs-5">Code postale</label>
                <input placeholder="ex : 70200" class="rounded-3 input-custom p-1" type="number" name="code_addresse"
                    require id="code_addresse" onkeyup="verif_code()">

                <label for="ville" class="mt-3 fs-5">Ville</label>
                <input placeholder="ex : Frotey-lès-Lure" class="rounded-3 input-custom p-1" type="text" name="ville"
                    require id="ville" onkeyup="verification_ville()">

                <label for="email" class="mt-3 fs-5">E-mail</label>
                <input placeholder="ex : exemple@gmail.com" class="rounded-3 input-custom p-1" type="mail" name="email"
                    required id="email" onkeyup="verification_mail()">

                <label for="num" class="mt-3 fs-5">Téléphone</label>
                <input placeholder="ex : 01 23 45 67 89" class="rounded-3 input-custom p-1" type="text" name="num"
                    required id="num" onkeyup="verification_num()">
            </section>
            <div class="d-flex justify-content-around flex-row mt-2">
                <button onclick="return_card1()"
        ...
        <div class="mt-5 background rounded-4 pt-3 pb-3" id="card3">
            <section class="w-75 mx-auto d-flex flex-column">
                ...
                <input class="rounded-3 input-custom p-1" type="password" name="password" required id="password"
                    onkeyup="verification_password()">

                <label for="password" class="mt-3 fs-5">Confirmation mot de passe</label>
                <input class="rounded-3 input-custom p-1" type="password" name="password2" required id="password_double"
                    onkeyup="verification_double_password()">
