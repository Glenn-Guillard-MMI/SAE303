...
<body class="bg-body overflow-x-hidden">
  ...
  <div id="nav-responsive" class="d-none position-fixed w-100">
    <nav id="nav-responsive-balise" class="p-3 w-100 text-white overflow-hidden">
      ...
      <section id="lien_menu" class="flex-column justify-content-around">
        ...
        <div class="text-center mt-2">
          <a class="lien_nav text-decoration-none text-white text-lien px-4 py-2" href="#container_formation">FORMATIONS</a>
        </div>
        <div class="text-center mt-2">
  ...
  <section class="bg-white hauteur text-dark z-3 position-relative">
    ...
    <article id="container-meteo" class="px-1 bg-body w-75 h-75 m-auto rounded-4 font meteo d-flex flex-row justify-content-around align-items-center text-white">
  ...
  <section id="margin_top_bapteme">
    ...
    <h6 id="type-appareil-titre" class="font text-white text-center mt-3">Notre association possède que <strong>3 types d’appareil </strong>
    </h6>
                ...
                <div class="card_equipe" style="background-image: url(ImagesEquipe/<?= $ligne7["image"] ?>.png)">
                  <div class="content">
                    <div class="d-flex h-75 flex-column justify-content-center align-items-center">
                      <p class="text-center text-white size-2-5 shadow-custom mb-0"><?= $ligne7["prenom"] ?> <?= $ligne7["nom"] ?></p>
                      <p class="text-center text-white shadow-custom mb-1"><?= $ligne7["fonction"] ?></p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      ?>
          <div class="d-flex flex-row mt-5">
            <div class="img-event w-25 rounded-4 bg-white d-grid justify-content-center align-content-center">
              <img src="ImagesEvenement/<?= $lign["image"] ?>.png" alt="<?= $lign["nom"] ?>" class="w-100 rounded-4 box-shadow-custom-event">
            </div>
            <div class="info-event w-75 d-flex flex-column justify-content-start ml-custom-event text-white">
              ...
              <a class="button_event text-decoration-none p-3 rounded-4 size-2 fw-bold" href="<?= $lign["lien"] ?>" target="_blank">En savoir
                plus</a>
            </div>
          </div>
      <?php
  ...
  <section class="bg-white pb-5 pt-2 z-2 position-relative">
    ...
    <form id="form-avis" method="post" action="_avis.php" class="w-50 d-flex align-content-center justify-content-around flex-column mx-auto">
      ...
      <input class="button_avis d-inline-flex justify-content-center align-items-center text-white p-2 size-2-5 mt-4" type="submit" value="Envoyer">
    </form>
  </section>
  ...
  <section id="degrade-custom" class="z-3 position-relative">
    ...
    <article id="contact" class="mt-custom">
      <div id="container-contact" class="d-flex flex-row justify-content-around">
        ...
        <div id="contact-form-container" class="text-white w-50 container_contact container-fluid margin-r-custom-contact">
