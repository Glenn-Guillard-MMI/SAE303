...
<body class="bg-body overflow-x-hidden">
  ...
  if (!isset($_COOKIE['ACF2L'])) {
    ...
    <section id="margin_top_bapteme">
        ...
        <h6 class="font text-white text-center mt-3">Notre association possède que <strong>3 types d’appareil </strong>
        </h6>
        ...
        try {
          ...
          foreach ($resultat as $ligne) {
            ?>
                <div
                    class='carte_avion w-25 color-blue-bapteme d-flex justify-content-around align-items-center flex-column'>
                    <form action="_reservBapteme.php" method="POST"
                      ...
                      ?>
                            ...
                            <div class='w-100'>
                                <input class='test-date w-100 mt-1' name="date" type='text'
                                    placeholder='Choisir une date ..' readonly='readonly'>
                            </div>
                            <div class=''>
                                <input class='test-time w-100 mt-1' name="heure" type='text'
                                    placeholder='Choisir une heure ..' readonly='readonly'>
                            </div>
                        </div>
                        <div class='d-flex flex-row align-items-center justify-content-around color-red-bapteme mt-5'>
                            <div>
                                <p class='m-0'><span class='non-strong-text'>à partir de</span><strong
                                        class='strong-text fst-italic'>
                                        <?= $ligne["prix"] ?> €
                                    </strong></p>
                            </div>
                            <input type='submit' value='Réserver'
                                class='button_reserver_bapteme px-2 text-white size-2-5'>
                        </div>
                    </form>
                    <?php
          ...
          ?>
            <form method="post" action="_reserveForfait.php" class="carte3 w-25 p-3 rounded-4">
              ...
              ?>
                ...
                <h4 class="text-center mt-3"><?= $ligne5["nom"] ?></h4>
                <ul class="px-4 mt-3">
                    <?php
              ...
              ?>
                ...
                <div class="d-flex justify-content-center my-auto mt-4">
                    <input type="submit" value="S'incrire"
                        class="button_reserver_bapteme px-2 text-white w-50 fs-4 mt-4">
                </div>
            </form>
            <?php
        }
          ...
          ?>
            <div class="d-flex flex-row mt-5">
                ...
                <div class="w-75 d-flex flex-column justify-content-start ml-custom-event text-white">
                    ...
                    <a class="button_event text-decoration-none p-3 rounded-4 size-2 fw-bold"
                        href="<?= $lign["lien"] ?>" target="_blank">En savoir
                        plus</a>
                </div>
            </div>
            <?php
    ...
    <section class="bg-white pb-5 pt-2 z-2 position-relative">
      ...
      ?>
            ...
            <input
                class="button_avis d-inline-flex justify-content-center align-items-center text-white p-2 size-2-5 mt-4"
                type="button" value="Envoyer">
        </form>
    </section>

    <section id="degrade-custom" class="z-3 position-relative">
        <img id="nuage_bas_footer" class="nuage rotation w-100 z-3 position-relative" src="img/SVG/nuage2fin.svg"
            alt="">
                ...
                <div class="text-white container_contact container-fluid margin-custom-contact">
                    ...
                    <div class="d-flex flex-row justify-content-around w-50  mt-4">
                        <a href="" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 51 51"
                                fill="none">
                                <path
                        ...
                        <a href="" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 37 37"
                                fill="none">
                                <path
                        ...
                        <a href="" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 36 37"
                                fill="none">
    ...
    <section class="d-flex justify-content-center align-items-center p-2 bg-custom-footer">
        <p class="text-white size-2-5 my-auto">Un projet de <a
                href="https://www.linkedin.com/in/valentin-lamour-732488252/" target="_blank"
                class="text-decoration-none lien-footer">Valentin Lamour</a>, <a
