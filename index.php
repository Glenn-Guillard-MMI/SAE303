...
<body class="bg-body overflow-x-hidden">
  ...
  <section class="d-flex flex-column justify-content-center align-items-center m-4">
    ...
    <article id="font-local-header" class="text-white h6 font">à l'Aéro Club de Frotey-les-Lure</article>
  </section>
  ...
  <section class="bg-white hauteur text-dark z-3 position-relative">
    <h3 class="text-center font color_meteo size-3 mb-4">Météo à Frotey-les-Lure</h3>
    <article class="px-1 bg-body w-75 h-75 m-auto rounded-4 font meteo d-flex flex-row justify-content-around align-items-center text-white">
      <div class="h-100 pt-4 d-flex align-content-center justify-content-around flex-column">
      ...
      <div class="h-100 pt-4 d-flex align-content-center justify-content-around flex-column">
        ...
        <img id="meteo1" class="meteo_img" src="img/meteo/Rain.png" alt="">
      ...
      <div class="h-100 pt-4 d-flex align-content-center justify-content-around flex-column">
        ...
        <img id="meteo2" class="meteo_img" src="img/meteo/Rain.png" alt="">
      ...
      <div class="h-100 pt-4 d-flex align-content-center justify-content-around flex-column">
        ...
        <img id="meteo3" class="meteo_img" src="img/meteo/Rain.png" alt="">
      ...
      <div class="h-100 pt-4 d-flex align-content-center justify-content-around flex-column">
        ...
        <img id="meteo5" class="meteo_img" src="img/meteo/Rain.png" alt="">
      ...
      <div class="h-100 pt-4 d-flex align-content-center justify-content-around flex-column">
        ...
        <img id="meteo6" class="meteo_img" src="img/meteo/Rain.png" alt="">
    ...
    <p id="width_meteo_lien" class="color_meteo text-center font mt-3 size-2 overflow-hidden mx-auto">Pour plus
      d’informations rendez vous sur le site <a class="text-decoration-none fw-bold meteo_france" target="_blank" href="https://vigilance.meteofrance.fr/fr/haute-saone">vigilance.meteofrance.fr</a></p>
  </section>
  ...
  <h5 class="text-white text-center font mt-5">6 classes d'ULM</h5>
  <section class="container-fluid h-25 width_avion_section mt-3">
    <article class="row mt-4">
      <div class="col d-flex flex-column justify-content-between align-content-center"><img class="w-100 drop_shodow_img" src="img/icon_avion/noun-parachute-4423885.png" alt="">
        <p class="text-shadow size-2-5 mt-2 text-white text-center">Paramoteur</p>
      </div>
      <div class="col d-flex justify-content-center align-content-center">
        <div class="bg-white barre h-75"></div>
      </div>
      <div class="col d-flex flex-column justify-content-between align-content-center"><img class="w-100 drop_shodow_img" src="img/icon_avion/icones aircraft.png" alt="">
        <p class="text-shadow size-2-5 mt-2 text-white text-center">Pendulaire</p>
      </div>
      <div class="col d-flex justify-content-center align-content-center">
        <div class="bg-white barre h-75"></div>
      </div>
      <div class="col d-flex flex-column justify-content-between align-content-center"><img class="w-100 drop_shodow_img" src="img/icon_avion/avion-leger.png" alt="">
        <p class="text-shadow size-2-5 mt-2 text-white text-center">Multiaxe</p>
      </div>
      <div class="col d-flex justify-content-center align-content-center">
        <div class="bg-white barre h-75"></div>
      </div>
      <div class="col d-flex flex-column justify-content-between align-content-center"><img class="w-100 drop_shodow_img" src="img/icon_avion/autogire (1).png" alt="">
        <p class="text-shadow size-2-5 mt-2 text-white text-center">L'autogire ultraléger</p>
      </div>
      <div class="col d-flex justify-content-center align-content-center">
        <div class="bg-white barre h-75"></div>
      </div>
      <div class="col d-flex flex-column justify-content-between align-content-center"><img class="w-100 drop_shodow_img" src="img/icon_avion/airship.png" alt="">
        <p class="text-shadow size-2-5 mt-2 text-white text-center">L'aérostat ultraléger</p>
      </div>
      <div class="col d-flex justify-content-center align-content-center">
        <div class="bg-white barre h-75"></div>
      </div>
      <div class="col d-flex flex-column justify-content-between align-content-center"><img class="w-100 drop_shodow_img" src="img/icon_avion/helicopter.png" alt="">
  ...
  <section id="margin_top_bapteme">
    <h3 class="font text-white text-center size-3">Nos offres pour un baptème de l'air</h3>
    <h6 class="font text-white text-center mt-3">Notre association possède que <strong>3 types d’appareil </strong></h6>
  ...
  <section id="formation" class="w-100">
    ...
    <div class="w-100 d-flex justify-content-around align-items-stretch mt-5">
      ...
      <article class="carte_avion2 w-25 d-flex justify-content-between align-items-center flex-column color-blue-bapteme" style="flex: 0 0 25%;">
        <h3 class="mt-4 size-3">Brevet de pilote</h3>
        <div class="w-75 rounded-5 barre-horizontale"></div>
        <ul class="mt-5 size-2">
          <li>Validité 1 an</li>
          <li class="mt-2">Cours illimités</li>
          <li class="mt-2">Formation à pieds ou en chariot</li>
          <li class="mt-2">Prêt du matériel</li>
          <li class="mt-2">10 vols minimum</li>
          <li class="mt-2">Cours théorique</li>
          <li class="mt-2">1 cours de perfectionnement</li>
          <li class="mt-2">Brevet d'Initiation Aéronotique (BIA)</li>
        </ul>
        <div class="d-flex flex-row justify-content-around align-items-center w-100 mt-5 mb-3">
          <p class="color-red-bapteme fst-italic size-3 my-auto">1200 €</p>
          <input type="button" value="S'incrire" class="button_reserver_bapteme px-2 text-white fs-5">
        </div>
      </article>

      <article class="carte_avion2 w-25 d-flex justify-content-around align-items-center flex-column color-blue-bapteme" style="flex: 0 0 25%;">
        <h3 class="mt-4 size-3">Emport de passager</h3>
        <div class="w-75 rounded-5 barre-horizontale"></div>
        <ul class="mt-5 size-2">
          <li>Durée de 6h à 8h</li>
          <li class="mt-2">Évaluation préalable du pilote</li>
          <li class="mt-2">Formation biplace à pied ou en chariot</li>
          <li class="mt-2">Avec lle matériel du stagiaire</li>
          <li class="mt-2">4 vols minimum</li>
          <li class="mt-2">Sensibilisation aux facteurs humains</li>
        </ul>
        <div class="d-flex flex-row justify-content-around align-items-center w-100 mt-auto mb-3">
          <p class="color-red-bapteme fst-italic size-3 my-auto">450 €</p>
          <input type="button" value="S'incrire" class="button_reserver_bapteme px-2 text-white fs-5">
        </div>
      </article>

      <article class="carte_avion2 w-25 d-flex justify-content-around align-items-sm-center flex-column color-blue-bapteme" style="flex: 0 0 25%;">
        <h3 class="mt-4 size-3">Stage d'initiation</h3>
        <div class="w-75 rounded-5 barre-horizontale"></div>
        <ul class="mt-5 size-2 w-75">
          <li>Durée 3h</li>
          <li class="mt-2">Présentation de l'aéronef et notion de mécanique de vol</li>
          <li class="mt-2">Gonflage et pilotage d'un parapente au sol</li>
          <li class="mt-2">Vol de 20 min en biplace</li>
          <li class="mt-2">Initiation au pilotage</li>
        </ul>
        <div class="d-flex flex-row justify-content-around align-items-center w-100 mt-auto mb-3">
          <p class="font fst-italic color-red-bapteme size-3 my-auto">180 €</p>
          <input type="button" value="S'incrire" class="button_reserver_bapteme px-2 text-white fs-5">
        </div>
      </article>
  ...
  <section class="font">
    ...
    <article class="w-50 mx-auto avis_clients mt-4">
      ...
      <div class="size-1">
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iusto recusandae sint sunt sapiente porro provident
        quas doloribus ex odit pariatur ab deleniti, reiciendis ipsam iste facere distinctio nihil facilis assumenda
        ipsa repellendus mollitia laboriosam rem! In tempore repellendus, autem, iusto quos sunt molestiae fugit
        delectus enim libero beatae, pariatur inventore facilis sapiente. Amet, repudiandae nisi a eveniet, rerum
        reprehenderit voluptatem dolor, qui cum suscipit soluta. Aliquid dolorum reprehenderit laboriosam commodi
        quisquam, quibusdam et vero earum quasi non inventore quia fugiat illo aperiam consequatur quidem vel deleniti
  ...
  <section id="formation2">
    ...
    <div class="d-flex flex-row justify-content-around align-items-center mt-5 color_meteo hauteur_container">

      <article class="carte3 w-25 p-3 rounded-4">
        <h2 class="font text-center mt-3 size-5">500 €</h2>
        <div class="w-75 rounded-5 barre-horizontale mx-auto"></div>
        <h4 class="text-center mt-3">Forfait initiation</h4>
        <ul class="px-4 mt-3">
          <li>Idéal pour s'initier au pilotage</li>
          <li class="mt-3">5 vols avec un instructeur du club</li>
          <li class="mt-3">5h de vol</li>
          <li class="mt-3">Idéal pour se faire une idée</li>
          <li class="mt-3">Essence comprise</li>
        </ul>
        <div class="d-flex justify-content-center my-auto mt-4">
          <input type="button" value="S'incrire" class="button_reserver_bapteme px-2 text-white w-50 fs-4 mt-4">
        </div>
      </article>

      <article class="carte3 w-25 p-3 rounded-4">
        <h2 class="font text-center mt-3 size-5">90 €/h</h2>
        <div class="w-75 rounded-5 barre-horizontale mx-auto"></div>
        <h4 class="text-center mt-3">Forfait membre</h4>
        <ul class="mt-3 px-4">
          <li>Prix pour les 10 premières heures</li>
          <li class="mt-3">Cotisation club 105 €</li>
          <li class="mt-3">Cotisation moins de 25 ans 60 €</li>
          <li class="mt-3">Assurance comprise</li>
          <li class="mt-3">Avoir licence FFFPLUM ou FFW</li>
        </ul>
        <div class="d-flex justify-content-center my-auto mt-4">
          <input type="button" value="S'incrire" class="button_reserver_bapteme px-2 text-white w-50 fs-4 mt-4">
        </div>
      ...
      <article class="carte3 w-25 p-3 rounded-4">
        <h2 class="font text-center mt-3 size-5">64 €/h</h2>
        <div class="w-75 rounded-5 barre-horizontale mx-auto"></div>
        <h4 class="text-center mt-3">Forfait membre +40h</h4>
        <ul class="mt-3 px-4">
          <li>+10 = 75 € par heure</li>
          <li class="mt-3">+20 = 71 € par heure</li>
          <li class="mt-3">+30 = 67 € par heure</li>
          <li class="mt-3">Moins de 25 ans = -20%</li>
          <li class="mt-3">Avoir licence FFFPLUM ou FFW</li>
        </ul>
        <div class="d-flex justify-content-center my-auto mt-4">
          <input type="button" value="S'incrire" class="button_reserver_bapteme px-2 text-white w-50 fs-4 mt-4">
  ...
  <section id="formation" class="w-100">
    ...
    <article class="text-white size-2-5 w-50 mx-auto mt-5 fw-light">
      Notre aéro-club est dédié à la formation des pilotes et instructeurs, tout en offrant des baptêmes de l'air. Nous
      proposons une gamme de services complémentaires pour soutenir notre communauté aéronautique.
    </article>
    <h3 class="text-white text-center mt-5">Nos Services</h3>
    ...
    <h3 class="text-white text-center mt-5">Infrastructures</h3>
    <article class="w-100 text-white d-flex flex-row mt-5">
      <div class="w-50 size-2 d-flex justify-content-center align-content-center">
        <div class="size-2-5 fw-light">
    ...
    <h3 class="text-white text-center mt-5">Notre équipe</h3>
    ...
    <article class="w-75 mx-auto mt-5">
      <div class="d-flex flex-row">
        <div class="w-25 rounded-4 bg-white d-grid justify-content-center align-content-center">
          <img src="img/event-3.jpg" alt="France air expo" class="w-100 rounded-4 box-shadow-custom-event">
        </div>
        <div class="w-75 d-flex flex-column justify-content-start ml-custom-event text-white">
          <h3 class="text-white">France Aire Expo 2023</h3>
          <div class="barre-custom-event bg-white rounded-5 w-50"></div>
          <p class="mt-2 size-2">1 juin 2023 - 3 juin 2023</p>
          <p class="mb-2 size-2">Aéroport de Lyon-Bron - Bron, France</p>
          <a class="button_event text-decoration-none p-3 rounded-4 size-2 fw-bold" href="" target="_blank">En savoir
            plus</a>
        </div>
      </div>
      ...
      <div class="d-flex flex-row mt-5">
        <div class="w-25 rounded-4 bg-white d-grid justify-content-center align-content-center">
          <img src="img/event-1.png" alt="France air expo" class="w-100 rounded-4 box-shadow-custom-event">
        </div>
        <div class="w-75 d-flex flex-column justify-content-start ml-custom-event text-white">
          <h3 class="text-white">Journée Sécurité des vols - Grand Est</h3>
          <div class="barre-custom-event bg-white rounded-5 w-50"></div>
          <p class="mt-2 size-2">1 juin 2023 - 3 juin 2023</p>
          <p class="mb-2 size-2">Serrouville, France</p>
          <a class="button_event text-decoration-none p-3 rounded-4 size-2 fw-bold" href="" target="_blank">En savoir
            plus</a>
        </div>
      </div>
      ...
      <div class="d-flex flex-row mt-5">
        <div class="w-25 rounded-4 bg-white d-grid justify-content-center align-content-center">
          <img src="img/event-5.jpg" alt="France air expo" class="w-100 h-75 rounded-4 box-shadow-custom-event mt-4">
        </div>
        <div class="w-75 h-75 d-flex flex-column justify-content-start ml-custom-event text-white my-auto">
          <h3 class="text-white">1er rassemblement ULM des Femmes Pilotes</h3>
          <div class="barre-custom-event bg-white rounded-5 w-50"></div>
          <p class="mt-2 size-2"> 8 mars 2023 - 9 mars 2023</p>
          <p class="mb-2 size-2">Saint-Martin-De-Castillon, France</p>
          <a class="button_event text-decoration-none p-3 rounded-4 size-2 fw-bold" href="" target="_blank">En savoir
            plus</a>
        </div>
      </div>
      ...
      <div class="d-flex flex-row mt-5">
        <div class="w-25 rounded-4 bg-white d-grid justify-content-center align-content-center">
          <img src="img/event-2.jpg" alt="France air expo" class="w-100 rounded-4 box-shadow-custom-event">
        </div>
        <div class="w-75 d-flex flex-column justify-content-start ml-custom-event text-white">
          <h3 class="text-white">Noel vu du ciel</h3>
          <div class="barre-custom-event bg-white rounded-5 w-50"></div>
          <p class="mt-2 size-2">1 décembre 2021- 12 décembre 2021</p>
          <p class="mb-2 size-2">Saint Laurent du Maroni, Guyanne</p>
          <a class="button_event text-decoration-none p-3 rounded-4 size-2 fw-bold" href="" target="_blank">En savoir
            plus</a>
        </div>
      </div>
  ...
  <section id="formation">
    ...
    <article class="slider3 position-relative w-100 d-grid overflow-hidden mb-5">
      <div class="slide-track3 h-75 d-flex overflow-hidden">
        <div class="slide3 d-flex align-items-center h-100 my-auto p-3"><img class="rounded-3" src="img/course-3.jpg" alt=""></div>
        <div class="slide3 d-flex align-items-center h-100 my-auto p-3"><img class="rounded-3" src="img/troisAutogires.jpg" alt=""></div>
        <div class="slide3 d-flex align-items-center h-100 my-auto p-3"><img class="rounded-3" src="img/pendulaire1.jpg" alt=""></div>
        <div class="slide3 d-flex align-items-center h-100 my-auto p-3"><img class="rounded-3" src="img/pendulaire.jpg" alt=""></div>
        <div class="slide3 d-flex align-items-center h-100 my-auto p-3"><img class="rounded-3" src="img/slide-3.jpg" alt=""></div>
        <div class="slide3 d-flex align-items-center h-100 my-auto p-3"><img class="rounded-3" src="img/cours-5.jpg" alt=""></div>
  ...
  <section class="bg-white pb-5 pt-2 z-2 position-relative">
    ...
    <form class="w-50 d-flex align-content-center justify-content-around flex-column mx-auto">
      ...
      <input class="button_avis d-inline-flex justify-content-center align-items-center text-white p-2 size-2-5 mt-4" type="button" value="Envoyer">
    </form>
  </section>
  ...
  <section id="degrade-custom" class="z-3 position-relative">
    ...
    <article class="mt-custom">
      <div class="d-flex flex-row justify-content-around">
        <div class="text-white container_contact container-fluid margin-custom-contact">
        ...
        <div class="text-white w-50 container_contact container-fluid margin-r-custom-contact">
          <h2 class="text-white">CONTACTER NOUS !</h2>
          <p>Laissez votre message, nous vous contacterons dans la semaine</p>
          <form class="d-flex flex-column">
            <div class="d-flex flex-row justify-content-between">
              <input type="text" placeholder="Nom" class="input-custom-contact width-custom-contact-input px-3 py-2 fs-6">
              <input type="email" placeholder="E-mail" class="input-custom-contact width-custom-contact-input px-3 py-2 fs-6">
            </div>
            <input type="text" placeholder="Sujet" class="input-custom-contact mt-3 px-3 py-2 fs-6">
            <textarea placeholder="Comment pouvons-nous vous aider ?" class="input-custom-contact-textarea mt-3 fs-6 px-3 py-2"></textarea>
            <input type="button" value="Envoyer" class="w-25 mt-4 button-contact-custom size-2-5 rounded-3 text-white mx-auto p-2">
          </form>
        </div>
      </div>
    </article>
  ...
  <section class="d-flex justify-content-center align-items-center p-2 bg-custom-footer">
    <p class="text-white size-2-5 my-auto">Un projet de <a href="https://www.linkedin.com/in/valentin-lamour-732488252/" target="_blank" class="text-decoration-none lien-footer">Valentin Lamour</a>, <a href="https://www.linkedin.com/in/glenn-guillard-08204724a/" target="_blank" class="text-decoration-none lien-footer">Glenn Guillard</a>, <a href="https://www.linkedin.com/in/thomas-henry-8a9652256/" target="_blank" class="text-decoration-none lien-footer">Thomas Henry</a> et <a href="https://www.linkedin.com/in/fabre-j%C3%A9r%C3%B4me-057b23257/" target="_blank" class="text-decoration-none lien-footer">Jérôme Fabre</a>. – ©
      2023 Aero
