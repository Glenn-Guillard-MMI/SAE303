...
<body class="bg-body overflow-x-hidden">
  ...
  <section class="d-flex flex-column justify-content-center align-items-center m-4">
    <h1 class="text-white" onclick="commence()">Bienvenue</h1>
  ...
  <section class="bg-white hauteur text-dark z-3 position-relative">
    ...
    <article
      class="bg-body w-75 h-75 m-auto rounded-4 font meteo d-flex flex-row justify-content-around align-items-center text-white">
  ...
  <section class="container-fluid h-25 width_avion_section mt-3">
    <article class="row mt-4">
      <div class="col d-flex flex-column justify-content-between align-content-center"><img
          class="w-100 drop_shodow_img" src="img/icon_avion/noun-parachute-4423885.png" alt="">
      ...
      <div class="col d-flex flex-column justify-content-between align-content-center"><img
          class="w-100 drop_shodow_img" src="img/icon_avion/icones aircraft.png" alt="">
      ...
      <div class="col d-flex flex-column justify-content-between align-content-center"><img
          class="w-100 drop_shodow_img" src="img/icon_avion/avion-leger.png" alt="">
      ...
      <div class="col d-flex flex-column justify-content-between align-content-center"><img
          class="w-100 drop_shodow_img" src="img/icon_avion/autogire (1).png" alt="">
      ...
      <div class="col d-flex flex-column justify-content-between align-content-center"><img
          class="w-100 drop_shodow_img" src="img/icon_avion/airship.png" alt="">
      ...
      <div class="col d-flex flex-column justify-content-between align-content-center"><img
          class="w-100 drop_shodow_img" src="img/icon_avion/helicopter.png" alt="">
          ...
          foreach ($resultat as $ligne) {
            ...
            <div class='carte_avion w-25 color-blue-bapteme d-flex justify-content-around align-items-center flex-column'>
              <form action="_reservBapteme.php" method="POST"
                class='w-75 d-flex justify-content-around align-items-center flex-column'>
                <img class='img_card_bapteme mx-auto mt-5 rounded-3 object-fit-cover'
                  src='ImageBapteme/<?= $ligne["image"] ?>.png' alt='ULM pendulaire'>
                ...
                <div class='d-flex flex-column mb-3 w-100'>
                  ...
                  <div class='mt-1 mx-auto w-100'>
                    <input class='test-date w-100' name="date" type='text' placeholder='Choisir une date ..'
                      readonly='readonly'>
                  </div>
                  <div class='mt-1 mb-5'>
                    <input class='test-time w-100' name="heure" type='text' placeholder='Choisir une heure ..'
                      readonly='readonly'>
                  </div>
                </div>
                <div class='d-flex flex-row align-items-center justify-content-around color-red-bapteme mb-4'>
                  ...
                  <input type='submit' value='Réserver' class='button_reserver_bapteme px-2 text-white fs-5'>
                </div>
              </form>
              <?php
              if (isset($_SESSION["message_err"])) {
                echo "<p class='text-center position-absolute text-danger fw-bold'>" . $_SESSION["message_err"] . "</p>";
            ...
            if (isset($_SESSION["message_cor"])) {
              echo "<p class='text-center position-absolute text-success fw-bold'>" . $_SESSION["message_cor"] . "</p>";
  ...
  <section id="formation" class="w-100">
    ...
    <div class="w-100 d-flex justify-content-around align-items-stretch mt-5">
      ...
      <article
        class="carte_avion2 w-25 d-flex justify-content-between align-items-center flex-column color-blue-bapteme"
        style="flex: 0 0 25%;">
      ...
      <article class="carte_avion2 w-25 d-flex justify-content-around align-items-center flex-column color-blue-bapteme"
        style="flex: 0 0 25%;">
      ...
      <article
        class="carte_avion2 w-25 d-flex justify-content-around align-items-sm-center flex-column color-blue-bapteme"
        style="flex: 0 0 25%;">
  ...
  <section id="formation2">
    ...
    <div class="d-flex flex-row justify-content-around align-items-center mt-5 color_meteo hauteur_container">
      ...
      <article class="carte_avion2 w-25 p-3">
  ...
  <section class="bg-white pb-5 pt-2">
    ...
    <form class="w-50 d-flex align-content-center justify-content-around flex-column mx-auto">
      <label class="mt-4 size-2-5">Nom et prénom</label>
      <input type="text" class="w-50" id="input_avis">
      ...
      <input class="button_avis d-inline-flex justify-content-center align-items-center text-white p-2 size-2-5 mt-2"
  ...
  <section id="degrade-custom" class="z-3 position-relative">
    ...
    <article id="formation">
      <div id="contact" class="arrive_avion"></div>
        ...
        <div class="text-white w-50 container_contact container-fluid margin-r-custom-contact">
          ...
          <form class="d-flex flex-column">
            <div class="d-flex flex-row justify-content-between">
              <input type="text" placeholder="Nom" class="input-custom-contact width-custom-contact-input">
              <input type="email" placeholder="E-mail" class="input-custom-contact width-custom-contact-input">
            </div>
            <input type="text" placeholder="Sujet" class="input-custom-contact mt-3">
            <textarea placeholder="Comment pouvons-nous vous aider ?"
              class="input-custom-contact-textarea mt-3"></textarea>
  ...
  <footer class="position-relative">
    <a href="" class="position-absolute text-white lien_compte size-2-5">Compte</a>
  ...
  <section class="d-flex justify-content-center align-items-center p-2 bg-custom-footer">
    <p class="text-white size-2-5 my-auto">Un projet de <a href="" target="_blank"
        class="text-decoration-none lien-footer">Valentin Lamour</a>, <a href="" target="_blank"
        class="text-decoration-none lien-footer">Glenn Guillard</a>, <a href="" target="_blank"
        class="text-decoration-none lien-footer">Thomas Henry</a> et <a href="" target="_blank"
  ...
  <script src="js/input_time.js"></script>
