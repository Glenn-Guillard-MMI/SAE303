...
<body class="font-normal text-blue">
        ...
        <section class="w-75 ml-custom d-flex flex-column mt-3 justify-content-between mb-5">
            ...
            <article class="d-flex flex-column w-100">
                <div class="d-flex flex-row text-white">
                    ...
                    <div class="w-25 bg-custom-3 d-flex flex-column justify-content-center align-items-center rounded-3 py-3 px-4 shadow-box-stat mb-4 me-4">
                    ...
                    <div class="w-25 bg-custom-3 d-flex flex-column justify-content-center align-items-center rounded-3 py-3 px-4 shadow-box-stat mb-4">
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <th><button class="text-danger fw-medium bg-white rounded-4 px-3 button-annuler-reserv" onclick="confirmsupprBapt(<?= $id ?>)"><i class="fas p-2 rounded-3 fa-trash me-2 mb-0 icon-annul"></i>Annuler</button></th>
                                </tr>
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <th><button class="text-danger fw-medium bg-white rounded-4 px-3 button-annuler-reserv" onclick="confirmsupprForfait(<?= $id ?>)"><i class="fas p-2 rounded-3 fa-trash me-2 mb-0 icon-annul"></i>Annuler</button></th>
                                </tr>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <th><button class="text-danger fw-medium bg-white rounded-4 px-3 button-annuler-reserv" onclick="confirmsupprForm(<?= $id ?>)"><i class="fas p-2 rounded-3 fa-trash me-2 mb-0 icon-annul"></i>Annuler</button></th>
    ...
    <div id="confirmBapt" class="rounded-4 bg-white">
        <div class="d-flex justify-content-around align-items-center flex-column h-100">
            ...
            <div class="d-flex flex-row justify-content-around align-items-center w-100">
                <p onclick="annul()" class="px-2 py-1 rounded-3 bg-white button_annul">Annuler</p>
                <p id="button_supprBapt" onclick="SuppressionBatptemeAdherant(this.value)" value="" class="px-2 py-1 rounded-3 text-white">Supprimer</p>
            </div>
        </div>
    </div>
    <div id="confirmForm" class="rounded-4 bg-white">
        <div class="d-flex justify-content-around align-items-center flex-column h-100">
            ...
            <div class="d-flex flex-row justify-content-around align-items-center w-100">
                <p onclick="annul()" class="px-2 py-1 rounded-3 bg-white button_annul">Annuler</p>
                <p id="button_supprForm" onclick="SuppressionFormationAdherant(this.value)" value="" class="px-2 py-1 rounded-3 text-white">Supprimer</p>
            </div>
        </div>
    </div>
    <div id="confirmForfait" class="rounded-4 bg-white">
        <div class="d-flex justify-content-around align-items-center flex-column h-100">
            ...
            <div class="d-flex flex-row justify-content-around align-items-center w-100">
                <p onclick="annul()" class="px-2 py-1 rounded-3 bg-white button_annul">Annuler</p>
                <p id="button_supprForfait" onclick="SuppressionForfaitAdherant(this.value)" value="" class="px-2 py-1 rounded-3 text-white">Supprimer</p>
            </div>
        </div>
    </div>
    <div id="overlay"></div>
