    ...
    <nav class="container-fluid p-3 w-100 text-white">
        <section class="row">
          ...
          <div class="col text-center mt-2">
            <a class="lien_nav text-decoration-none text-white" href="index.html#bapteme">BAPTÈME DE L'AIR</a>
          </div>
          <div class="col text-center mt-2">
      ...
      <section>
        ...
        <article id="background" class=" w-25 d-flex flex-column justify-content-center align-items-center rounded-4 mx-auto text-blue">
            ...
            <h2 class="text-blue">Utiliser votre compte</h2>
            <form action="_connexion_compt.php" method="post" class="d-flex flex-column mt-5">
                <label class="size-2-5">Adresse mail</label>
                <input type="mail" name="email" id="email" placeholder="ex : personne@gmail.com" class="p-1 rounded-3 input_connexion">
                <label class="mt-4 size-2-5">Mot de passe</label>
                <input type="password" name="password" id="password" placeholder="ex : 12a3B4_" class="p-1 rounded-3 input_connexion">
                <span class="d-flex flex-row mt-4 justify-content-around">
