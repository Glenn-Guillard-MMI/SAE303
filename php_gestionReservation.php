                          ...
                          <tr>
                              ...
                              <th>
                                  ...
                                  <span class="d-flex flex-row align-items-center justify-content-around">
                                      <p class="p-2 icon-shadow rounded-3 mb-0 icon_confirm"
                                          onclick="AccepterBaptemePilote(<?= $ligne2['num_res'] ?>)">
                                          <i class="fas fa-check text-success px-1"></i>
                                      </p>
                                      <p class="p-2 icon-shadow rounded-3 mb-0 icon_confirm"
                                          onclick="RefuserBaptemePilote(<?= $ligne2['num_res'] ?>)">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <th>
                              ...
                              <span class="d-flex flex-row align-items-center justify-content-around">
                                  <p class="p-2 icon-shadow rounded-3 mb-0 icon_confirm"
                                      onclick="AccepterFormation(<?= $ligne2['num_res'] ?>)">
                                      <i class="fas fa-check text-success px-1"></i>
                                  </p>
                                  <p class="p-2 icon-shadow rounded-3 mb-0 icon_confirm"
                                      onclick="RefuserFormation(<?= $ligne2['num_res'] ?>)">
                                      <i class="fas fa-times text-danger px-1"></i>
                                  </p>
                              </span>
                          </th>
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <th>
                          ...
                          <span class="d-flex flex-row align-items-center justify-content-around">
                              <p class="p-2 icon-shadow rounded-3 mb-0 icon_confirm"
                                  onclick="AccepterForfait(<?= $ligne2['num_res'] ?>)">
                                  <i class="fas fa-check text-success px-1"></i>
                              </p>
                              <p class="p-2 icon-shadow rounded-3 mb-0 icon_confirm"
                                  onclick="RefuserForfait(<?= $ligne2['num_res'] ?>)">
                                  <i class="fas fa-times text-danger px-1"></i>
                              </p>
                          </span>
                      </th>
